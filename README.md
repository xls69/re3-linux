<img src="https://github.com/xls69/re3-linux/blob/master/res/images/logo_1024.png?raw=true" alt="re3 logo" width="200">

# DISCLAIMER

**This fork of re3 specifically focuses on the Linux platform (x86, amd64) and does not guarantee compatibility with other architectures or platforms!**
...
![re3 2021-02-11 22-57-03-23](https://github.com/xls69/re3-linux/blob/master/res/images/re3_1.png)
![re3 2021-02-11 22-43-44-98](https://github.com/xls69/re3-linux/blob/master/res/images/re3_2.png)
![re3 2021-02-11 22-46-33-76](https://github.com/xls69/re3-linux/blob/master/res/images/re3_3.png)
![re3 2021-02-11 22-50-29-54](https://github.com/xls69/re3-linux/blob/master/res/images/re3_4.png)
...
Clone the repository with `git clone --recursive https://github.com/xls69/re3-linux.git`. Then `cd re3-linux` into the cloned repository.
...
> :information_source: There are various settings in [config.h](https://github.com/xls69/re3/tree/master/src/core/config.h), you may want to take a look there.
...
We have a [Coding Style](https://github.com/xls69/re3-linux/blob/master/CODING_STYLE.md) document that isn't followed or enforced very well.
